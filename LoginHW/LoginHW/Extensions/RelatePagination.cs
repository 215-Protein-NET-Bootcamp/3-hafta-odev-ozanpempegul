...
namespace ProteinApi.Base
{
    ...
    {
        public static void CreatePaginationResponse<Response, Pagination>(this PaginationResponse<Response> response, Pagination pagination, int totalRecords) where Pagination : QueryResource
        {
